...
cd /var/tmp/pcs_consul	
/opt/chef/embedded/bin/berks vendor ..
/opt/chef/bin/chef-client -z -c /var/tmp/pcs_consul/solo/solo.rb -j /tmp/chef.json -o 'recipe[pcs_consul::default]'  #TECHDEBT better way to do this sort of thing 
